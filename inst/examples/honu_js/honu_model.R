...
js_code <- nimbleCode({
  ...
  #' ---------------------------------------------------------------------------
  #' Entry, survival, and reproductive state
  #' ---------------------------------------------------------------------------

  # Entry probability (rho, xi, and xi_tilde)
  for(t in 1:K){
  ...
  #' ---------------------------------------------------------------------------
  #' HMM matrices (see helper/*.R for nimble functions to load matrices)
  #' ---------------------------------------------------------------------------
  ...
  #' ---------------------------------------------------------------------------
  #' Posterior predicted superpopulationn abundance
  #' ---------------------------------------------------------------------------
